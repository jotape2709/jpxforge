...
import { LandingContentSchema, parseModelOutput, type PipelineRouter } from "../pipeline/contracts.js";
...
export async function buildLanding(router: PipelineRouter, spec: Spec, projectId: string, signal?: AbortSignal) {
  ...
  return parseModelOutput(LandingContentSchema, result.content);
}
